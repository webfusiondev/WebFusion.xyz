  ...
  return (
    <>
      <main className="min-h-[80vh] md:min-h-screen flex flex-col relative overflow-x-clip">
        <nav className="px-4 md:px-8 lg:px-16 xl:px-24 py-6 flex items-center h-32 justify-between select-none text-xl border-b border-b-secondary">
          <Logo />
        ...
        <section className="py-20 md:py-28 lg:py-32 xl:py-44 px-8 md:px-16 xl:px-24 flex flex-col justify-center grow">
        ...
        <Image
          ...
          width={396}
          height={206}
          style={{ left: 0, transform: "translate(-33%, 31.6%)", bottom: 0, position: "absolute", maxWidth: "25vw" }}
        ...
        <Image
          ...
          width={396}
          height={206}
          style={{ bottom: 0, right: "0", transform: "translate(33%, 31.6%)", position: "absolute", maxWidth: "25vw" }}
          src="/pattern-stripe.png"
        />
      </main>
      <section
      ...
      >
        ...
        >
          <div className="event-card md:hover:text-brand-black col-span-6 md:col-span-3 xl:col-span-2 border border-secondary p-12 md:p-20 xl:p-24">
            <div className="font-bold text-xl md:text-2xl xl:text-3xl mb-6">Hackathons</div>
          ...
          <div className="event-card md:hover:text-brand-black col-span-6 md:col-span-3 xl:col-span-2 border border-secondary p-12 md:p-20 xl:p-24">
            <div className="font-bold text-xl md:text-2xl xl:text-3xl mb-6">Bootcamps</div>
            <p className="md:text-lg xl:text-xl mb-8">
          ...
          <div className="event-card md:hover:text-brand-black col-span-6 md:col-span-3 xl:col-span-2 border border-secondary p-12 md:p-20 xl:p-24">
            <div className="font-bold text-xl md:text-2xl xl:text-3xl mb-6">Workshops</div>
            <p className="md:text-lg xl:text-xl mb-8">
          ...
          <div className="event-card md:hover:text-brand-black col-span-6 md:col-span-3 border border-secondary p-12 md:p-20 xl:p-24">
            <div className="font-bold text-xl md:text-2xl xl:text-3xl mb-6">Webinars</div>
            <p className="md:text-lg xl:text-xl mb-8">
        ...
        <div className="overflow-hidden mb-40">
          ...
          >
            <div className="border border-secondary px-14 py-16 col-span-6 md:col-span-3 xl:col-span-2">
              ...
              <div className="text-xl md:text-2xl xl:text-3xl mb-4 font-bold">Developer Courses</div>
            ...
            <div className="border border-secondary px-14 py-16 col-span-6 md:col-span-3 xl:col-span-2">
              ...
              <div className="text-xl md:text-2xl xl:text-3xl mb-4 font-bold">Blockchain Courses</div>
              <p className="md:text-lg xl:text-xl">
            ...
            <div className="border border-secondary px-14 py-16 col-span-6 md:col-span-3 xl:col-span-2">
              ...
              <div className="text-xl md:text-2xl xl:text-3xl mb-4 font-bold">Developer Resources</div>
              <p className="md:text-lg xl:text-xl">
